...
class TokenVazioValidator:
    ...
    STRUCTURED_CLOSURE_PATHS = {
        ...
        "configs/canari-integration.v1.json": "L11",
        "scripts/validate_canari_integration.py": "L11",
        "tests/test_canari_integration.py": "L11",
        "docs/CANARI_MALTEGO_INTEGRATION.md": "L11",
