...
sh tools/rafbbs/rafbbs_build.sh commandless
...
cc -std=c11 -Wall -Wextra -Werror -D_POSIX_C_SOURCE=200809L -I tools/rafbbs tools/rafbbs/tests/rafbbs_baremetal_overflow_test.c -o /tmp/rafbbs_baremetal_overflow_test
/tmp/rafbbs_baremetal_overflow_test
cc -std=c11 -Wall -Wextra -Werror -D_POSIX_C_SOURCE=200809L -I tools/rafbbs tools/rafbbs/tests/rafbbs_manifest_bin_test.c -o /tmp/rafbbs_manifest_bin_test
/tmp/rafbbs_manifest_bin_test
