...
> **Entrada canônica:** docs/AGENTES.md §5 (pipeline operacional — freestanding C, ARM64, estados VOID→VALIDATED) e §4 (regras de não-colisão — zero heap em hot path, sem NULL-deref, sintaxe obrigatória). Este documento detalha o protocolo de engenharia bare-metal, benchmark honesto e retroalimentação ética para trabalho com RAFAELIA.
