...
def category(n:int, name:str)->str:
    # Order matters: the ARM64 counter/barrier subset lives inside the broader
    # 021-035 Linux/MMIO band and must be classified before that broad band.
    ...
    if n in (54, 55): return 'benchmark/cache/batching'
